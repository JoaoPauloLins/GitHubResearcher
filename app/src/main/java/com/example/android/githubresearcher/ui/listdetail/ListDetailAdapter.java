...
import com.example.android.githubresearcher.ui.menu.repositories.RepositoriesAdapter;
...
public class ListDetailAdapter extends RecyclerView.Adapter<ListDetailAdapter.RepositoriesViewHolder>{

    private List<Repo> repositories = new ArrayList<>();
    private Activity activity;
    private Context context;

    public ListDetailAdapter(Activity activity, Context context) {
    ...
    public RepositoriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ListDetailAdapter.RepositoriesViewHolder(view);
    }
